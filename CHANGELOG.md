...
### Changed
- Documentation overhaul — updated README.md, CONTRIBUTING.md, CHANGELOG.md, AGENTS.md, .gitignore, .prettierignore to reflect current project state (59 providers, 115 test files, GitHub Actions CI/CD, 32 CSS modules)
- Renamed JEAN.md → AGENTS.md to follow canonical Jean2 convention
...
### Changed
- Provider count adjusted to 59 (consolidated from earlier additions)
